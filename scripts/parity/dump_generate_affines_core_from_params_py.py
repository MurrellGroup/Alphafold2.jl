...
def main() -> None:
    ...
    out_act, out_affine = transformed.apply(params, k_apply, single, pair, seq_mask, aatype)
    ...
    print(f"Saved real-weight generate-affines-core dump: {args.out}")
